export function integral(f_int, a_int, b_int, n_int) {
  n_int = n_int || 500;
  if (function () {
    var res_int = true;
    const varObject_int = [
...
export function derivative(f_d, a_d, dx_d) {
  dx_d = dx_d || 9e-8;
  if (function () {
    var res_d = true;
    const varObject_d = [
...
export function sumf(f_sum, a_sum, b_sum) {
  if (function () {
    var res_sum = true;
    const varObject_sum = [
...
export function prodf(f_prod, a_prod, b_prod) {
  if (function () {
    var res_prod = true;
...
export function trig(trigf_trig, angle_trig) {
...
export function nth_root(value_nth_root, n_nth_root) {
...
export function log_base(a_log_base, b_log_base) {
  if (function () {
